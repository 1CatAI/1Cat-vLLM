...
// Shared by wheel instantiations and isolated geometry microbenchmarks.
...
namespace {
using namespace FI_GDN_IMPL_NAMESPACE;
...
void run(torch::Tensor hidden, torch::Tensor weights, torch::Tensor qkv,
  ...
  TORCH_CHECK(props->major == 7 && props->minor == 0, "SM70 GDN adapter only");
