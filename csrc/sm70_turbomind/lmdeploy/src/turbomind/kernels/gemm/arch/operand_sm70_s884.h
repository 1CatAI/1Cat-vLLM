...
// Pad each activation row by eight half values. For K32/K64 batch
// tiles this avoids repeatedly addressing the same shared-memory banks.
// Weight layout and arithmetic remain unchanged.
template<class T>
