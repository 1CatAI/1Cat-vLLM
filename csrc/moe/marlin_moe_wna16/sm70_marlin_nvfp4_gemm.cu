...
class Sm70MoeNvfp4IteratorB {
 ...
 public:
  CUTLASS_DEVICE
  Sm70MoeNvfp4IteratorB(Params const& params, uint32_t const* qweight,
  ...
  CUTLASS_DEVICE
  Sm70MoeNvfp4IteratorB& operator++() {
...
struct Sm70MoeNvfp4GemmSpec {
  using ScaleElement = uint8_t;
  using ZeroElement = half;
  static constexpr bool kUsesGlobalScale = true;
