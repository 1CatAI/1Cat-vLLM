    ...
    def free_blocks(
        ...
        Args:
            ordered_blocks: A list of blocks to free ordered by their eviction
                priority.
            prepend: Put the newly free blocks at the front of the free queue
                so they are reused before cached blocks. Used for blocks that
                carry no prefix-cache value (unhashed transient state), so a
                request's own churn does not flush older cached prefixes.
        """
